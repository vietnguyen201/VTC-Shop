...
<head>
    ...
    <link rel="stylesheet" href="<?php echo _WEB_ROOT; ?>/public/assets/styles/css/swiper-bundle.min.css" />
    <link rel="stylesheet" href="<?php echo _WEB_ROOT; ?>/public/assets/styles/css/fontMIcon.css" />
    <script src="<?php echo _WEB_ROOT; ?>/public/assets/JS/swiper-bundle.min.js"></script>
...
<body>
    <?php $this->render('blocks/clients/header'); ?>
    <?php $this->render($content,$subcontent); ?>
    <?php $this->render('blocks/clients/footer'); ?>
</body>
</html>